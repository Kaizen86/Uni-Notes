...
# Parallelism
This is when the different tasks are truly running at the same time, as multiple instructions are executing simultaneously. This is only possible for systems with multiple processor cores. This can improve performance, at the cost of increased power usage.
![[Multitasking.png]]
